...
const TransactionsPagination = ({ currentPage, setCurrentPage, totalPages }) => {
  return (
    <div className="px-6 py-3 flex justify-between items-center border-t border-white/10 bg-gray-800 backdrop-blur-sm rounded-2xl">
      <button
